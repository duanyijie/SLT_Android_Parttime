...
public class SplashActivity extends BaseActivity implements
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.niit.slt_andriod_parttime.MESSAGE_RECEIVED_ACTION";
	...
	private void setTagAlias() {
		String alias = "0";//可以设置为用户id
		String tag = "hk";//可以设置为用户所在组
		...
		JPushInterface
				.setAliasAndTags(SplashActivity.this, alias, tagSet, this);
	}
	...
	public void onLocationChanged(AMapLocation location) {
		if (location != null) {
			...
			PreferencesUtils.putString(SplashActivity.this, "cityname",
					cityName);
			PreferencesUtils.putString(SplashActivity.this, "citycode",
					cityCode);
